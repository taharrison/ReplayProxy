...
namespace CoderTom.Mimics.ExampleDomain.Tests
{
    [TestFixture]
    public class ConsumerIntegrationTests
    {
        ...
        /// end to end, without using Mimics at all.
        /// </summary>
        /// <remarks>
        ...
        public void CustomerReportShouldContainAllCustomersMissingAddresses_RecordBehaviour()
        {
            ...
            Mimic.SaveHistoryToFile(recorderProxy, "MissingAddressReport_CallHistory_out.xml");
        }
        ...
        public void CustomerReportShouldContainAllCustomersMissingAddresses_IsolationTest()
        {
            ...
            // we are using a stub.  this kind of test double has no object behind it; it pretends to be the required
