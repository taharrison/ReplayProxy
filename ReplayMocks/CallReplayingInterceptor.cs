...
{
    public class CallReplayingInterceptor : IInterceptor
    {
        public History Log { get; set; }
        public bool AllowAccessToObject { get; set; }

        public CallReplayingInterceptor(History history)
        {
            AllowAccessToObject = false;
            Log = history;
        }

        public void Intercept(IInvocation invocation)
        {
            Log.ReplayMethodResult(invocation);
